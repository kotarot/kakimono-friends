...
class CNN(chainer.Chain):
    ...
    def __call__(self, x):
        h1 = F.max_pooling_2d(F.relu(self.conv1(x)), 2, pad=1)  # ksize=2
        h2 = F.max_pooling_2d(F.relu(self.conv2(h1)), 2, pad=1) # ksize=2
...
def main():
    ...
    parser.add_argument('--out', '-o', default='result_cnn_v3',
