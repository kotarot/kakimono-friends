...
class CNN(chainer.Chain):
    ...
    def __call__(self, x):
        ...
        h3 = F.max_pooling_2d(F.relu(self.conv3(h2)), 2) # ksize=2
        h4 = F.max_pooling_2d(F.relu(self.conv4(h3)), 2) # ksize=2
        h5 = F.dropout(F.relu(self.l1(h4)))
        return self.l2(h5)
...
def main():
    ...
    parser.add_argument('--out', '-o', default='result_cnn_v5',
